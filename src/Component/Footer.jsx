      ...
      <div className="max-w-full mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4">
            ...
            {/* X */}
            <button class="w-6 h-6 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-300">
            ...
            {/* LinkdIn */}
            <button class="w-6 h-6 flex items-center relative overflow-hidden justify-center rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300">
              ...
              {/* Instagram */}
            <a href="#" className="group inline-block cursor-pointer transition duration-300 ease-in-out" />
            <button class="w-6 h-6 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-500">
              <svg class="fill-gray-900 relative z-10 transition-all duration-500 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 51 51" fill="none">
                <path
