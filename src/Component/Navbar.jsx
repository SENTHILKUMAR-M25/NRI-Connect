        ...
        <div className="hidden lg:block">
          <ul className="flex flex-col gap-2  lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
            ...
            <>
              ...
              <li className="flex items-center p-1 text-sm gap-x-2 text-green-800">
      ...
      {MenuOpen && (
        <div className="absolute top-full left-0 w-full bg-white shadow-md lg:hidden">
          <ul className="flex flex-col ">
            <li className="flex items-center justify-center p-4 text-sm border-b border-gray-100 gap-x-2 text-slate-600">
              <Link to="/home" className="flex items-center justify-center text-black w-full hover:bg-blue-600 py-1 rounded-xl hover:text-white text-center">Home</Link>
            </li>
            <li className="flex items-center p-4 text-sm border-b border-gray-100 gap-x-2 text-slate-600">
              <Link to="/selling" className="flex items-center justify-center text-black w-full hover:bg-blue-600 py-1 rounded-xl hover:text-white text-center">Sell</Link>
            </li>
            <li className="flex items-center p-4 text-sm border-b border-gray-100 gap-x-2 text-slate-600">
              <Link to="/service" className="flex items-center justify-center text-black w-full hover:bg-blue-600 py-1 rounded-xl hover:text-white text-center">Service</Link>
            </li>
            <li className="flex items-center p-4 text-sm border-b border-gray-100 gap-x-2 text-slate-600">
              <Link to="/contact" className="flex items-center justify-center text-black w-full hover:bg-blue-600 py-1 rounded-xl hover:text-white text-center">Contact</Link>
            </li>
