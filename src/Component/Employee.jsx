    ...
    <div className="p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
      ...
      <div className="flex gap-6 items-center">
        ...
        <button
          ...
          className="relative inline-flex flex-wrap items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800">
          <span 
          className="relative p-2 lg:px-5 lg:py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
      ...
      {/* Full Profile Details (conditional) */}
      {showFullProfile && (
        <>
          {/* Bio */}
          <div className="mt-4">
          ...
          {/* Admin Only Section */}
            <div className=' hidden'>
              <div className="mt-6 bg-yellow-50 p-4 rounded-lg border border-yellow-300">
                <h2 className="font-semibold text-lg mb-2">Admin Only Section</h2>
                <p className="text-sm text-gray-700">
                  This section is visible only to the admin for verification purposes.
                </p>
                <ul className="mt-2 list-disc pl-6 text-sm">
                  <li>ID Proof Status: {emp.idProof ? 'Uploaded ✅' : 'Not Uploaded ❌'}</li>
                  <li>Certificate Status: {emp.certificate ? 'Uploaded ✅' : 'Not Uploaded ❌'}</li>
                </ul>
              </div>
            </div>
          ...
          <button type="button" className="text-white  mt-6 flex justify-end gap-4 bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
            <Link
              to="/enquiry"
              className='flex gap-1.5'
            >
              Book now
              <svg className=" relative top-1  rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
